...
},beforePageText:"页码",afterPageText:"共 {pages} 页",displayMsg:"显示第 {from} 到 {to} 条 共 {total} 条记录",nav:{first:{iconCls:"pagination-first",handler:function(){
...
$.fn.switchbutton.defaults={handleWidth:"auto",width:60,height:30,checked:false,disabled:false,readonly:false,reversed:false,onText:"开",offText:"关",handleText:"",value:"on",label:null,labelWidth:"auto",labelPosition:"before",labelAlign:"left",onChange:function(_4f2){
}};
})(jQuery);
(function($){
var _4f3=1;
