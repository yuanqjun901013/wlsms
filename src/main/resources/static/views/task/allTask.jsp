...
<div class="easyui-layout" data-options="fit:true">
    <div data-options="region:'center'">
        <div id="toolbar">
            <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="deleteBatch()">批量删除</a>
    ...
    <script type="text/javascript" th:inline="none">
        ...
        function deleteBatch(){
            ...
            var row = $('#getTaskList').datagrid('getChecked');
            if (row){
                var ids = "";
                ...
                $.messager.confirm('确认提醒','确定删除这些数据?',function(r){
                    if (r){
                        $.post('/task/deleteBatch',{ids:ids},function(result){
                            if (result.success){
